...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  private void moveSpinner(float paramFloat) {
    ...
    if (this.mCustomSlingshotDistance > 0) {
      f1 = this.mCustomSlingshotDistance;
    } else {
      int k;
      if (this.mUsingCustomStart) {
        k = this.mSpinnerOffsetEnd - this.mOriginalOffsetTop;
      } else {
        k = this.mSpinnerOffsetEnd;
      } 
      f1 = k;
    } 
  ...
  public void requestDisallowInterceptTouchEvent(boolean paramBoolean) {
    if ((Build.VERSION.SDK_INT < 21 && this.mTarget instanceof android.widget.AbsListView) || (this.mTarget != null && !ViewCompat.isNestedScrollingEnabled(this.mTarget)))
      return; 
...
/* Location:              /home/geo/hackathon/GROW/apk/dex2jar-2.0/classes-dex2jar.jar!/androidx/swiperefreshlayout/widget/SwipeRefreshLayout.class
