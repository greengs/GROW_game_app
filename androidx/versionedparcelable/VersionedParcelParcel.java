...
class VersionedParcelParcel extends VersionedParcel {
  ...
  protected VersionedParcel createSubParcel() {
    ...
    if (this.mNextRead == this.mOffset) {
      int k = this.mEnd;
      return new VersionedParcelParcel(parcel, j, k, this.mPrefix + "  ");
    } 
    int i = this.mNextRead;
    return new VersionedParcelParcel(parcel, j, i, this.mPrefix + "  ");
  }
...
/* Location:              /home/geo/hackathon/GROW/apk/dex2jar-2.0/classes-dex2jar.jar!/androidx/versionedparcelable/VersionedParcelParcel.class
