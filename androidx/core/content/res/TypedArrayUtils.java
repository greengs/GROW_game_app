...
public class TypedArrayUtils {
  ...
  public static ComplexColorCompat getNamedComplexColor(@NonNull TypedArray paramTypedArray, @NonNull XmlPullParser paramXmlPullParser, @Nullable Resources.Theme paramTheme, @NonNull String paramString, @StyleableRes int paramInt1, @ColorInt int paramInt2) {
    if (hasAttribute(paramXmlPullParser, paramString)) {
      ...
      ComplexColorCompat complexColorCompat2 = ComplexColorCompat.inflate(paramTypedArray.getResources(), paramTypedArray.getResourceId(paramInt1, 0), paramTheme);
      ComplexColorCompat complexColorCompat1 = complexColorCompat2;
      return (complexColorCompat2 == null) ? ComplexColorCompat.from(paramInt2) : complexColorCompat1;
    } 
...
/* Location:              /home/geo/hackathon/GROW/apk/dex2jar-2.0/classes-dex2jar.jar!/androidx/core/content/res/TypedArrayUtils.class
