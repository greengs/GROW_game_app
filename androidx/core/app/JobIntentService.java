...
public abstract class JobIntentService extends Service {
  ...
  static final class CompatWorkEnqueuer extends WorkEnqueuer {
    ...
    CompatWorkEnqueuer(Context param1Context, ComponentName param1ComponentName) {
      ...
      this.mLaunchWakeLock = powerManager.newWakeLock(1, param1ComponentName.getClassName() + ":launch");
      this.mLaunchWakeLock.setReferenceCounted(false);
      this.mRunWakeLock = powerManager.newWakeLock(1, param1ComponentName.getClassName() + ":run");
  ...
  static abstract class WorkEnqueuer {
    ...
    void ensureJobId(int param1Int) {
      ...
      if (this.mJobId != param1Int)
        throw new IllegalArgumentException("Given job ID " + param1Int + " is different than previous " + this.mJobId); 
    }
...
/* Location:              /home/geo/hackathon/GROW/apk/dex2jar-2.0/classes-dex2jar.jar!/androidx/core/app/JobIntentService.class
