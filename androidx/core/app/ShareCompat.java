...
public final class ShareCompat {
  ...
  public static void configureMenuItem(MenuItem paramMenuItem, IntentBuilder paramIntentBuilder) {
    ...
    shareActionProvider.setShareHistoryFileName(".sharecompat_" + paramIntentBuilder.getActivity().getClass().getName());
  ...
  public static ComponentName getCallingActivity(Activity paramActivity) {
    ...
    if (componentName2 == null)
      componentName1 = (ComponentName)paramActivity.getIntent().getParcelableExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY"); 
  ...
  public static String getCallingPackage(Activity paramActivity) {
    ...
    String str1 = str2;
    if (str2 == null)
      str1 = paramActivity.getIntent().getStringExtra("androidx.core.app.EXTRA_CALLING_PACKAGE"); 
    return str1;
  }
  ...
  public static class IntentBuilder {
    ...
    private IntentBuilder(Activity param1Activity) {
      ...
      this.mIntent.putExtra("androidx.core.app.EXTRA_CALLING_PACKAGE", param1Activity.getPackageName());
      this.mIntent.putExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY", (Parcelable)param1Activity.getComponentName());
...
/* Location:              /home/geo/hackathon/GROW/apk/dex2jar-2.0/classes-dex2jar.jar!/androidx/core/app/ShareCompat.class
