...
public class AlertDialogLayout extends LinearLayoutCompat {
  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2) {
    ...
    if (view1 != null) {
      ...
      j = View.combineMeasuredStates(0, view1.getMeasuredState());
    } 
    i = 0;
    int i2 = 0;
    int m = j;
    ...
    if (view3 != null) {
      ...
      n = k + i;
      m = View.combineMeasuredStates(j, view3.getMeasuredState());
    } 
    int i1 = 0;
    j = m;
    k = n;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    //   147: checkcast androidx/appcompat/widget/LinearLayoutCompat$LayoutParams
    //   150: astore #16
    //   152: aload #16
...
/* Location:              /home/geo/hackathon/GROW/apk/dex2jar-2.0/classes-dex2jar.jar!/androidx/appcompat/widget/AlertDialogLayout.class
