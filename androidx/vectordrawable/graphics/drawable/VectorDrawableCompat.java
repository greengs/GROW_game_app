...
public class VectorDrawableCompat extends VectorDrawableCommon {
  ...
  private boolean needMirroring() {
    return (Build.VERSION.SDK_INT >= 17) ? ((isAutoMirrored() && DrawableCompat.getLayoutDirection(this) == 1)) : false;
  }
  ...
  private static abstract class VPath extends VObject {
    ...
    public String nodesToString(PathParser.PathDataNode[] param1ArrayOfPathDataNode) {
      ...
      for (int i = 0; i < param1ArrayOfPathDataNode.length; i++) {
        str = str + (param1ArrayOfPathDataNode[i]).mType + ":";
...
/* Location:              /home/geo/hackathon/GROW/apk/dex2jar-2.0/classes-dex2jar.jar!/androidx/vectordrawable/graphics/drawable/VectorDrawableCompat.class
